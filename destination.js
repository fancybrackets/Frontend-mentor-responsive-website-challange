...
for(let i = 0 ; i<buttons.length ; i++ ) {
        buttons[i].addEventListener("click", function() {
            ...
            if( i == 0  )  {
                document.getElementById("img").setAttribute("src" , "images/destination/image-moon.webp");
             ...
             if( i == 1  )  {
                    document.getElementById("img").setAttribute("src" , "images/destination/image-mars.webp");
             ...
             if( i == 2  )  {
                document.getElementById("img").setAttribute("src" , "images/destination/image-europa.webp");
         ...
         if( i == 3  )  {
            document.getElementById("img").setAttribute("src" , "images/destination/image-titan.webp");
